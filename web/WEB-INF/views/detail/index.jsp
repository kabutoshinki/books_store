    ...
    <div class="col">
        ...
        <div class="col">
            ...
            <div>
                ...
                <c:if test="${book.quantity == 0}"><h3 style="margin-left: 10px;color: red">Sold out</h3></c:if>
                ...
                <div class="input-group mb-3">
                    <input type="number" id="quantity" name="quantity" value="1" style="width: 70px;text-align: right;" min="1" max="${book.quantity}">
