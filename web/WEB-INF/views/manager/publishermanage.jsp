    ...
    <tbody>
        <c:forEach var="publisher" items="${publisherList}">
            <tr>
                ...
                <td class="text-truncate" style="max-width: 150px;" title="${publisher.publisherName}">${publisher.publisherName}</td>
                <td class="text-truncate" style="max-width: 150px;" title="${publisher.publisherSummary}">${publisher.publisherSummary}</td>
                <td>
