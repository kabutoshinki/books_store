                ...
                <div class="card mb-2" style="padding: 10px;">
                    ...
                    <div class="row mt-2">
                        <div>
                            ...
                            <input type="text" name="name" class="form-control" value="${name==null?user.fullName:name}" required>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <label class="labels mb-2">Mobile Number</label>
                            <input type="text" name="phoneNumber" class="form-control" placeholder="Enter phone number" value="${phoneNumber==null?user.phoneNumber:phoneNumber}" required>
                        </div>

                        <div class="row mt-3">
                            <div class="col-md-12">
                                <label class="labels mb-2">Address</label>
                                <input type="text" name="address" class="form-control mb-3" value="${address==null?user.userAddress:address}" required>
                            </div>
                        </div>
