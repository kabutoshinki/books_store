...
<!--                                <td>
                                ...
                                <td>
                                    <h6 class="mt-4">
                                        <fmt:formatNumber value="${order.bookID.price}" pattern="$ #,##0.00" />
                                    </h6>
                                </td>
                                <td class="cart-product-quantity">
                                    <form action="change.do">
                                        ...
                                        <input type="number" value="${order.bookID.quantity}" id="number" name="quantityMax"" value="1" readonly hidden>                                            
                                        <button class="btn btn-outline-success" type="submit" name="op" value="increment" <c:if test="${order.bookID.quantity == order.quantity}">disabled</c:if>><i class="bi bi-caret-up-fill"></i></button>
                                    </form>
                                </td>
                                <td>
