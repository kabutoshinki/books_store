        ...
        <div class="container-fluid">
            ...
            <header>
                    ...
                    <div class="logo align-items-center">
                        <a href="${pageContext.request.contextPath}/home/index.do"><img class="rounded-circle" src="https://i.pinimg.com/originals/3c/7a/f3/3c7af3c03a1fc34f679d6cb8d1af703a.png" alt=""></a>
                        <h2>Book Store</h2>
                        <form action="<c:url value="/search/searchbar.do" />">
                            <input type="text" name="searchBar" placeholder="Search.." style="width: 500px; height: 45px;">
                        </form> 
                    </div>
            ...
            <div class="container mt-3">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" href="${pageContext.request.contextPath}/home/index.do">Home</a>
                    </li>
                    <li class="nav-item dropdown">
