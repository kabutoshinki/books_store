...
public class OrderItem implements Serializable {
    ...
    public OrderItem(Integer orderID, int quantity) {
        this.orderID = orderID;
        this.quantity = quantity;
    }

    public OrderItem(int quantity, Book bookID, Cart cartID) {
        this.quantity = quantity;
        this.bookID = bookID;
        this.cartID = cartID;
    }
    ...
    public String toString() {
        return "entities.OrderItem[ orderID=" + orderID + " ]";
    }
    
    public int getTotal() {
        return bookID.getPrice().intValue() * quantity * (100 - bookID.getDiscount()) / 100;
    }
